...
//gets a copy, receiver type - value receiver
...
func (c car) mph() float64 {
	c.top_speed_kmh = 666                                                           // Only changes the value of top_speed_kmh of local c car
	return float64(c.gas_pedal) * (c.top_speed_kmh / kmh_multiple / usixteenbitmax) //top speed: 140 mph.So do pedal * (225/1.60934/65535)
}

//modify the struct itself via pointer type - pointer receiver
